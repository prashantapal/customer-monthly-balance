...
insert into transaction (description, transaction_date, transaction_amount, transaction_type) values('Transferred from Jack XXX453657', now() - 35 day, 1379.77, 'CREDIT');
insert into transaction (description, transaction_date, transaction_amount, transaction_type) values('Transfer to John XXX455657', now() - 34 day, 2133.43, 'DEBIT');
insert into transaction (description, transaction_date, transaction_amount, transaction_type) values('Salary credited XXX4536757', now() - 33 day, 5000.00, 'CREDIT');
...
insert into transaction (description, transaction_date, transaction_amount, transaction_type) values('Salary credited XXX1335537', now() - 9 month, 7000.00, 'CREDIT');

insert into transaction (description, transaction_date, transaction_amount, transaction_type) values('Transfer to John XXX133117', now() - 10 month, 5000.00, 'DEBIT');
insert into transaction (description, transaction_date, transaction_amount, transaction_type) values('Transfer to Jack XXX135117', now() - 10 month, 1000.00, 'DEBIT');
insert into transaction (description, transaction_date, transaction_amount, transaction_type) values('Salary credited XXX1335117', now() - 10 month, 7000.00, 'CREDIT');